...
// test ortamındaki store'un kurulumunu yap. Projede thunk kullandığımız için onuda tanıtıyoruz
const mockStore = configureStore([thunk]);

it("yüklenme durumunda loader bileşenleri ekrana basılır", () => {
    // loading durumunda store'daki veriyi simüle et
...
it("veri gelme durumunda  ülke bilgisi ve kartlar ekrana basılır", () => {
    ...
    // resmin kaynağı datadaki resim url'i ile aynı mı kontrol et
